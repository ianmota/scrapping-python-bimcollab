...
class Application(ScrapperResearch,ScrapperColect):
    ...
    def Root01(self):
        ...
        with open("icons\Projete5D140x140png.png", "rb") as image_file:
    ...
    def Root01Button(self):    
        self.bt_confirmar = Button(self.root, text="Confirmar", font= ('verdana',11,'bold'),command=self._get_html)
        self.bt_confirmar.place(relx=0.4, rely=0.85)
        
        self.localSave_value = StringVar()
    ...
    def _get_html(self):
        ...
        self.lb_fraseImpacto["text"] = 'Iniciando...'
        ...
        self.lb_fraseImpacto["text"] = 'Coletando dados'
        self.lb_fraseImpacto["font"] = ('verdana',9)
    ...
    def _create_dictionary(self):
        ...
        self.dicionario = {}
        print(len(self.browser.htmlList))
    ...
    def _save(self):
        localSave = str(self.localSave_value.get())
        nomeEmail = self.en_usuario.get()
        nomeArquivo = nomeEmail.split('@')
        
        print(f"{localSave}/{nomeArquivo}.csv")